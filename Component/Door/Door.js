        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.rowContainer}>
                    <TouchableOpacity style={styles.taskContainer} onPress={() => this.sendMessage('Open')}><Task name={'Open'} /></TouchableOpacity>
                    <TouchableOpacity style={styles.taskContainer} onPress={() => this.sendMessage('Close')}><Task name={'Close'} /></TouchableOpacity>
                </View>
            </View>
        );
    }
